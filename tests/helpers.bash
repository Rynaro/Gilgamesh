#!/usr/bin/env bash
# tests/helpers.bash — shared test helpers for the Gilgamesh bats suite.
#
# Provides install fixtures and sha256 helpers for tests that exercise
# install.sh and the skills / schema layout.

# Absolute path to the Gilgamesh repo root (one level up from this file).
